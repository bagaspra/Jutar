  ...
  return (
    <PageWrapper>
      ...
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 px-4">
        <div>
          <h2 className="text-4xl font-black text-on-surface tracking-tight font-headline uppercase italic">Orders History</h2>
          <p className="text-neutral-500 mt-2 font-body font-medium">Review and manage all past transactions and terminal records.</p>
        </div>
      ...
      <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-outline/10 mx-4 editorial-shadow mb-10">
          ...
          <table className="w-full border-collapse text-left min-w-[1000px]">
            <thead>
              <tr className="bg-surface-variant/30 border-b border-outline/10">
                <th className="px-10 py-6 text-[11px] font-black text-on-surface-variant uppercase tracking-[0.2em] font-label">Transaction ID</th>
                <th className="px-10 py-6 text-[11px] font-black text-on-surface-variant uppercase tracking-[0.2em] font-label">Date & Time</th>
                <th className="px-10 py-6 text-[11px] font-black text-on-surface-variant uppercase tracking-[0.2em] font-label">Order Type / Qty</th>
                <th className="px-10 py-6 text-[11px] font-black text-on-surface-variant uppercase tracking-[0.2em] font-label text-right">Total Payment</th>
                <th className="px-10 py-6 text-[11px] font-black text-on-surface-variant uppercase tracking-[0.2em] font-label">Status</th>
                <th className="px-10 py-6 text-[11px] font-black text-on-surface-variant uppercase tracking-[0.2em] font-label text-center">Service</th>
              </tr>
            </thead>
              ...
              {orders && orders.length > 0 ? (
                ...
                <tr>
                  <td colSpan={6} className="h-64 flex flex-col items-center justify-center grayscale opacity-10">
                    ...
                    <p className="text-xs font-black uppercase tracking-widest text-center">Zero Transactions Recorded</p>
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div className="px-10 py-8 bg-surface-variant/20 flex items-center justify-between border-t border-outline/10">
          <p className="text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none">Terminal v1.2.0 • Data Sync Active</p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 px-4 pb-24">
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-outline/10 flex flex-col justify-between editorial-shadow min-h-[220px]">
          <div>
            <span className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] block mb-3 font-label opacity-60">Daily Gross Sales</span>
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-outline/10 flex flex-col justify-between editorial-shadow min-h-[220px]">
          <div>
            <span className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] block mb-3 font-label opacity-60">Completed Tickets</span>
            <h3 className="text-4xl font-black font-headline text-on-surface tabular-nums tracking-tighter">{totalOrdersToday} <span className="text-sm font-bold opacity-30">ORDERS</span></h3>
          </div>
          <div className="flex items-center gap-2 mt-auto">
          ...
          <div className="mt-auto flex justify-between items-end">
            <div className="flex flex-col gap-2">
               <div className="flex items-center gap-2">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest">Master Database Sync</p>
               </div>
