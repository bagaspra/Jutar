...
interface BadgeProps {
  ...
  variant?: "critical" | "low" | "orange" | "blue" | "green" | "plating" | "preparing" | "served";
  className?: string;
}
  ...
  return (
    <span
      className={cn(
        ...
        variant.startsWith('plating') || variant.startsWith('preparing') || variant.startsWith('served') || variant.startsWith('orange') || variant.startsWith('blue') || variant.startsWith('green') 
