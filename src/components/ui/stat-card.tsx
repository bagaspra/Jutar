...
export function StatCard({
  ...
  return (
    <div className="bg-white p-6 rounded-card editorial-shadow border border-outline/50 relative overflow-hidden group">
      {showLeftBorder && (
      ...
      <div className="flex justify-between items-start mb-6">
        <div className={cn(
          ...
          variant === "red" ? "bg-red-50" : variant === "orange" ? "bg-orange-50" : "bg-blue-50",
